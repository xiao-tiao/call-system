...
<div id="right_ctn">
    <div class="right_m">
        ...
        <tr aria-colspan="5">
            ...
            <a href="${type}Log.do?num=1">首页</a>

            <a href="${type}Log.do?num=${requestScope.pagehelper.prePage}">上一页</a>
            <c:forEach   items="${requestScope.pagehelper.navigatepageNums}" var="num">
            <a href="${type}Log.do?num=${num}">${num}</a>

            </c:forEach>

            <a href="${type}Log.do?num=${requestScope.pagehelper.nextPage}">下一页</a>
            <a href="${type}Log.do?num=${requestScope.pagehelper.pages}">末页</a>
            ...
            <script>
                function changeNumber()
                {
                    ...
                    window.location.href="${type}Log.do?num="+num;
